...
public class ResourceProperties {
     ...
     *
     * This code defines a method defaultAppConfigBundle that retrieves the default application configuration bundle as a
     * Properties object and loads it from a specified resource file. If there is an error loading the file, it will print the stack trace.
     * 
     ...
     *
     * This code defines a function that creates a properties object and loads data from a file called "IntegrationConf.properties" located in a specific directory.
     * The properties object contains integration configuration data.
     * If the file is not found or an error occurs during reading, the function prints the stack trace. Finally, it returns the properties object.
     * 
