...
public class CommonUtil {
  ...
  public Connection getDBConnection() throws ClassNotFoundException {
    ...
    try {
      conn = DriverManager.getConnection(ContentProperties.H2_DB_JDBC_URL, ContentProperties.H2_DB_JDBC_USER_NAME,
          ContentProperties.H2_DB_JDBC_PASSWORD);
    } catch (Exception e) {
      LogFileManager.INSTANCE
          .systemLogManager(ContentProperties.H2_DB_CONNECTION_CREATION_EXCEPTION_MSG.concat(e.getMessage()));
    }
    return conn;
  }
